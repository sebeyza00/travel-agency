...
- [x] **FLIGHTS-UI-004**: When displaying an option, the system shall show the airline, departure and arrival times, stop count, total duration, and the price breakdown.
- [x] **FLIGHTS-UI-005**: While viewing results, the system shall allow sorting by total price, total duration, departure time, and stop count.
- [x] **FLIGHTS-UI-006**: While viewing results, the system shall allow filtering by stop count, airline, departure-time window, and price range.
